#ifndef SIMPLEBLOCKS_H
#define SIMPLEBLOCKS_H
...
class SimpleBlocks : public Assignment
{
private:
...
void SimpleBlocks::initialize(cWorld *world, cCamera *camera)
{
    ...
    // Create a font
    cFontPtr font2 = NEW_CFONT_CALIBRI_20();
...
void SimpleBlocks::updateGraphics()
{
    std::stringstream ss;
...
void SimpleBlocks::updateHaptics(cGenericHapticDevice *hapticDevice, double timeStep, double totalTime)
{
...
cMultiMesh *SimpleBlocks::newBlock()
{
    cMultiMesh *simple_cube;
    simple_cube = new cMultiMesh();

    // load an object file
    bool fileload = simple_cube->loadFromFile("./Models/Block_simple.obj");
    /*
    todo
...
cMultiMesh *SimpleBlocks::dirtBlock()
{

    return SimpleBlocks::newBlock();
}
#endif
